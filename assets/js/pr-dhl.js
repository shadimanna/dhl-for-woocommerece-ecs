			...
			if ($('#pr_dhl_multi_packages_enabled').prop('checked')) {
				...
				if (!packages) {
					...
					if (packages == 'invalid_number') {
						...
						if (packages.length) {
							data['pr_dhl_packages_number'] =
								wc_shipment_dhl_label_items.get_package_array($form, 'number');
							data['pr_dhl_packages_weight'] =
								wc_shipment_dhl_label_items.get_package_array($form, 'weight');
							data['pr_dhl_packages_length'] =
								wc_shipment_dhl_label_items.get_package_array($form, 'length');
							data['pr_dhl_packages_width'] =
								wc_shipment_dhl_label_items.get_package_array($form, 'width');
							data['pr_dhl_packages_height'] =
								wc_shipment_dhl_label_items.get_package_array($form, 'height');
						}
					}
				}
			}
