...
class PR_DHL_Front_End_Paket {
	...
	public function load_styles_scripts() {
		...
		if( $this->is_parcelfinder_enabled() ) {
			// Enqueue Fancybox
			wp_enqueue_script( 'pr-dhl-fancybox-js', PR_DHL_PLUGIN_DIR_URL . '/assets/js/jquery.fancybox.min.js', array('jquery'), '3.3.5' );

			wp_enqueue_style( 'pr-dhl-fancybox-css', PR_DHL_PLUGIN_DIR_URL . '/assets/css/jquery.fancybox.min.css', array(), '3.3.5' );
